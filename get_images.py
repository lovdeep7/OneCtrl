...
if __name__ == '__main__':
    #download_list = ['curved tv', 'lcd tv', 'led tv', 'plasma tv', 'telvision', 'tv', 'tv in house', 'tv in office', 'tv in living room', 'tv in tv shelf']
    #for search_name in download_list:
    search_name = 'television'
